...
void start_race(){for(int i=0;i<NPIXELS;i++){track.setPixelColor(i, track.Color(0,0,0));};
                  ...
                  track.show();
                  delay(2000);
                  track.setPixelColor(12, track.Color(255,128,0));
                  track.setPixelColor(11, track.Color(255,128,0));
                  track.show();
                  ...
                  track.setPixelColor(10, track.Color(255,128,0));
                  track.setPixelColor(9, track.Color(255,128,0));
                  track.show();
                  digitalWrite(PIN_LED_O,HIGH);
                  tone(PIN_AUDIO,600);
                  delay(1000);
                  ...
                  track.setPixelColor(8, track.Color(255,128,0));
                  track.setPixelColor(7, track.Color(255,128,0));
                  track.show();
                  tone(PIN_AUDIO,1200);
                  delay(2000);
                  digitalWrite(PIN_LED_O,LOW);
...
void loop() {
    ...
    if ( (flag_sw1==1) && (digitalRead(PIN_P1)==0) ) {flag_sw1=0;speed1+=ACEL;}; //0
    if ( (flag_sw1==0) && (digitalRead(PIN_P1)==1) ) {flag_sw1=1;}; //1
